    ...
    <style>
      ...
      <div class="grid" style="grid-template-columns:repeat(3,1fr)">
        ...
        <div class="stat"><div class="stat-label">Best Day</div><div class="stat-value">${r.bestDay ? format(new Date(r.bestDay.date), 'MMM d') : 'N/A'}</div>
          ${r.bestDay ? `<div style="font-size:9px;color:#666">${formatCurrency(r.bestDay.sales)}</div>` : ''}</div>
      </div>
      </div>
      ...
      <div class="grid">
        ...
        <div class="stat"><div class="stat-label">Credit Paid</div><div class="stat-value green">${formatCurrency(r.creditPaid)}</div><div style="font-size:9px;color:#666">${r.creditPaidCount} payments</div></div>
